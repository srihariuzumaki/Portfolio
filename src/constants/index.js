...
export const myProjects = [
  {
    ...
    href: 'https://taskmate-007.vercel.app/',
  ...
  {
    title: 'JARVIS - Personal Assistant and Study Mentor',
    desc: 'JARVIS is a powerful Chatbot that can act as a Personal Assistant and Study Mentor with Voice Assistant..',
    subdesc:
      'With JARVIS, User can chat with the bot and ask about their acadamic needs and user can also upload materials and the bot will give you the summary of the particular file. and it has also voice feature that can be used to interact with the bot.',
    href: 'https://jarvis-ten-sage.vercel.app/',
